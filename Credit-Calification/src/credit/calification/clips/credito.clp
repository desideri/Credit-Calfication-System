;credito.clp
;Script that calify the credit of a person.
; The deftemplate that we used is for the evaluation of the credit information 
; of the person that is aplying for a credit. 
; We construct the following template and rules based of a decision tree 
; generated by ID3 algorithm.
